# ==============================================================================
# DOCKERFILE — Imagen del contenedor de la aplicación Login
# ==============================================================================
...
# ==============================================================================
# FROM define la imagen base. node:22-alpine es Node 22 sobre Alpine Linux,
...
# Aquí arrancamos el servidor. NO hay nodemon en producción.
